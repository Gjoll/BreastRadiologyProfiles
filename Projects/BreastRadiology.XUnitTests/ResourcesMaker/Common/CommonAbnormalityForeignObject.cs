...
namespace BreastRadiology.XUnitTests
{
    ...
    {
        async StringTask CommonAbnormalityForeignObject()
        {
            if (this.commonAbnormalityForeignObject == null)
                await this.CreateCommonAbnormalityForeignObject();
            return this.commonAbnormalityForeignObject;
        }
        String commonAbnormalityForeignObject = null;

        async VTask CreateCommonAbnormalityForeignObject()
        {
            await VTask.Run(async () =>
            {
                ...
                SDefEditor e = this.CreateEditor("CommonAbnormalityForeignObject",
                        "Foreign Object Abnormality",
                        "Foreign Object Abnormality",
                        ObservationUrl,
                        $"{Group_CommonResources}/AbnormalityForeign",
                        out this.commonAbnormalityForeignObject)
