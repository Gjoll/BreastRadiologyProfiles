                 ...
                 vs = Self.CreateCodeSystem(
                         ...
                         new ConceptDef[]
                         {
                             ...
                             new ConceptDef()
                                 ...
                                 .MammoId("233")
                                 .ValidModalities(Modalities.US)
                                 .SetUMLS("Calcifications usually can't be felt, but they appear " +
                                     "on a mammogram. ",
                             ...
                             new ConceptDef()
                                 ...
                                 .MammoId("234")
                                 .ValidModalities(Modalities.US)
                                 .SetUMLS("Calcifications are small deposits of calcium that " +
                             ...
                             new ConceptDef()
                                 ...
                                 .MammoId("231")
                                 .ValidModalities(Modalities.US)
                                 .SetSnomedDescription("ClinicalFinding | 44771000 | Microcalcifications " +
                                     "of the breast (Disorder) | [1/1] | R92.0")
                                 .SetUMLS("These show up as fine, white specks in a mammogram, " +
                                     "similar to grains of salt. ",
                                     "They're usually noncancerous, but certain patterns " +
                             ...
                             new ConceptDef()
                                 ...
                                 .SetUMLS("These are very thin benign calcifications that appear " +
