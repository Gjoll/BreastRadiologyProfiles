...
namespace BreastRadiology.XUnitTests
{
    partial class ResourcesMaker
    {
        ...
        Coding ComponentSliceCodeAbnormalityCystType =>
             new Coding(this.ObservationComponentSliceCodesUrl, "abnormalityCystType", "Component code for 'Cyst Type' slice");
        Coding ComponentSliceCodeAbnormalityDuctType => 
            new Coding(this.ObservationComponentSliceCodesUrl, "abnormalityDuctType", "Component code for 'Duct Type' slice");
        Coding ComponentSliceCodeAbnormalityFibroAdenomaType =>
            new Coding(this.ObservationComponentSliceCodesUrl, "mgAbnormalityFibroAdenomaType", "Component code for 'FibroAdenoma Type' slice");
        Coding ComponentSliceCodeAbnormalityForeignObjectType =>
            new Coding(this.ObservationComponentSliceCodesUrl, "abnormalityForeignObjectType", "Component code for 'Foreign Object Type' slice");
        Coding ComponentSliceCodeAbnormalityLymphNodeType =>
            new Coding(this.ObservationComponentSliceCodesUrl, "abnormalityLymphNodeType", "Component code for 'Lymph Node Type' slice");
        Coding ComponentSliceCodeAbnormalityMassType =>
            new Coding(this.ObservationComponentSliceCodesUrl, "abnormalityMassType", "Component code for 'Abnormality Mass Type' slice");

        Coding ComponentSliceCodeBiRads =>
            new Coding(this.ObservationComponentSliceCodesUrl, "targetBiRads", "Component code for 'BiRads Code' slice");
        Coding ComponentSliceCodeConsistentWithValue =>
            new Coding(this.ObservationComponentSliceCodesUrl, "consistentWithValue", "Component code for 'Consistent With Value' slice");
        ...
        Coding ComponentSliceCodeNotPreviouslySeen =>
            new Coding(this.ObservationComponentSliceCodesUrl, "notPreviouslySeen", "Component code for 'Not Previously Seen' slice");
        ...
        Coding MGComponentSliceCodeAbnormalityAsymmetryType =>
            new Coding(this.ObservationComponentSliceCodesUrl, "mgAbnormalityAsymmetryType", "Component code for 'Abnormality Asymmetry Type' slice");
        Coding MGComponentSliceCodeAbnormalityDensityType =>
            new Coding(this.ObservationComponentSliceCodesUrl, "mgAbnormalityDensityType", "Component code for 'Abnormality Density Type' slice");

        Coding MGComponentSliceCodeCalcificationType =>
            new Coding(this.ObservationComponentSliceCodesUrl, "mgCalcificationType", "Component code for 'Calcification Type' slice");
        Coding MGCodeCalcificationDistribution =>
            new Coding(this.ObservationComponentSliceCodesUrl, "mgCalcificationDistribution", "Component code for 'Distribution' slice");
