                        ...
                        new ConceptDef[]
                        {
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("A benign condition; Apocrine Metaplasia refers to " +
                                    ...
                                    "even develop into a palpable mass.###URL#https://breast-cancer.ca/apo-meta/")
                            ,
                            new ConceptDef()
                                .SetCode("Artifact")
                                .SetDisplay("Artifact")
                                ...
                                .SetUMLS("X-ray artifacts can present in a variety of ways " +
                                    ...
                                    "error and software (post-processing) artifacts. ",
                                    "There are common and distinct artifacts for film, " +
                                    "computed (CR) and digital radiography (DR). ",
                                    "Common causes are improper handling of the filmserrors " +
                                    "while processing the filmspatient movement while " +
                                    "taking the image. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Atypical hyperplasia is a precancerous condition " +
                                    ...
                                    "abnormal cells in the breast.Atypical hyperplasia " +
                                    "isn't cancer, but it can be a forerunner to the development " +
                                    "of breast cancer. ",
                                    "Over the course of your lifetime, if the atypical " +
                                    "hyperplasia cells keep dividing and become more abnormal, " +
                                    "this can transition into noninvasive breast cancer " +
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Axillary lymph nodes are the lymph nodes located " +
                                    ...
                                    "infections, lymphomas, and breast cancers. ",
                                    "Lymph nodes are small structures located all over " +
                                    "the body around blood vessels that act as filters " +
                                    "and can accumulate germs or cancer cells. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Simple cysts have smooth, thin, regularly shaped " +
                                    "walls and are completely filled with fluid. ",
                                    "The sound waves sent out by the ultrasound test pass " +
                                    "right through them, indicating there are no solid " +
                                    "areas. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Microcysts are tiny, microscopic cysts. ",
                                    ...
                                    "cysts and they only have fluid inside of them.")
                            ,
                            new ConceptDef()
                                .SetCode("DCIS")
                                .SetDisplay("DCIS")
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Because estrogen can promote the growth of breast " +
                                    ...
                                    "may have direct activity in breast tissue.###URL#https://www.cancer.gov/about-cancer/causes-prevention/risk/myths/antiperspirants-fact-sheet")
                            ,
                            new ConceptDef()
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("An abnormal dilation of a duct by lipids and cellular " +
                                    ...
                                    "to affect postmenopausal women, may be accompanied " +
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Breast edema is defined as a mammographic pattern " +
                                    ...
                                    "and interstitial marking. ",
                                    "It can be caused by benign or malignant diseases, " +
                                    "as a result of a tumor in the dermal lymphatics of " +
                                    "the breast, lymphatic congestion caused by breast, " +
                                    "lymphatic drainage obstruction, or by congestive " +
                                    "heart failure. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Fat Lobule. ",
                                    ...
                                    "mixed with dense fibroglandular tissue. ",
                                    "Fat lobule in breast. ",
                                    "Yes. ",
                                    "Breast tissue is composed of functional elements " +
                                    "(glands and ducts) as well as structural elements " +
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Breasts are made up of lobules (milk-producing glands) " +
                                    ...
                                    "term used to describe damaged or dead tissue). ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Another name for Hamartomas, Hamartomas represent " +
                                    ...
                                    "which is why the lesions are considered hamartomatous. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Fibroadenomas are common benign (non-cancerous) breast " +
                                    ...
                                    "and 30s, but they can be found in women of any age. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Fibrous tissue, which extends under the skin, from " +
                                    ...
                                    "wall, supports the breast and gives it shape. ",
                                    "Strands of supportive tissue surround the breast " +
                                    "and form a prominent ridge called the inframammary " +
                                    "ridge. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Folliculitis is the inflammation of hair follicles " +
                                    "due to an infection, injury, or irritation. ",
                                    "It is characterized by tender, swollen areas that " +
                                    "form around hair follicles, often on the neck, breasts, " +
                                    "buttocks, and face. ",
                                    "Boils (also referred to as furuncles) are pus-filled " +
                                    "lesions that are painful and usually firm. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Gynecomastia is an enlargement or swelling of breast " +
                                    ...
                                    "that are too high or are out of balance with testosterone " +
                                    "levels. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("A benign (not cancer) growth made up of an abnormal " +
                                    ...
                                    "area of the body where the growth occurs. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("A breast hematoma is a collection of blood that forms " +
                                    ...
                                    "lead to inflammation, fever, skin discoloration, " +
                                    "and may leave behind scar tissue that mimics the " +
                                    "shape of a breast tumor. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("These are lymph  nodes within the breast tissue. ",
                                    ...
                                    "upper portions of the breast closer to theaxilla " +
                                    "(armpit area), although they may occur anywhere in " +
                                    "the breast. ",
                                    "They usually are seen adjacent to a vein, because " +
                                    "the lymphatic drainage of the breast parallels the " +
                                    "venous drainage. ",
                                    "###ACRUS#")
                            ,
                            new ConceptDef()
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("A small bean-shaped structure that is part of the " +
                                    ...
                                    "(underarm), chest, abdomen, and groin. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Lymph nodes filter substances that travel through " +
                                    ...
                                    "(or smaller than 1/2 inch or 12mm).")
                            ,
                            new ConceptDef()
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("An abnormal mass of tissue that usually does not " +
                                    ...
                                    "cells that make blood vessels or lymph vessels. ",
                                    "Vascular tumors may be benign (not cancer) or malignant " +
                                    "(cancer) and can occur anywhere in the body. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Breast papillary lesions are characterised by growth " +
                                    ...
                                    "breast lesions and less than 1% of malignant breast " +
                                    "neoplasms. ",
                                    "Breast papillary lesions are usually detected by " +
                                    "imaging or clinically by the presence of a palpable " +
                                    "breast mass or unilateral spontaneous nipple discharge. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Intraductal papillomas are benign (non-cancerous), " +
                                    ...
                                    "tissue and blood vessels (called fibrovascular tissue). ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Phyllodes tumors of the breast are rare, accounting " +
                                    "for less than 1% of all breast tumors. ",
                                    "The name \"phyllodes,\" which is taken from the Greek " +
                                    "language and means \"leaflike,\" refers to that fact " +
                                    "that the tumor cells grow in a leaflike pattern. ",
                                    ...
                                    "quickly, and they require surgery to reduce the risk " +
                                    "of a phyllodes tumor coming back in the breast (local " +
                                    "recurrence). ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("This is scarring that occurs from the lumpectomy " +
                                    ...
                                    "forms around nerves.A lump of scar tissue forms in " +
                                    "the hole left after breast tissue is removed. ",
                                    "If scar tissue forms around a stitch from surgery " +
                                    "it's called a suture granuloma and also feels like " +
                                    "a lump.Changes in breast appearance. ",
                                    "Scar tissue and fluid retention can make breast tissue " +
                                    "appear a little firmer or rounder than before surgery " +
                                    "and/or radiation. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Post surgical scarring happens because of the incisions " +
                                    "needed to surgically remove tumor, cells, etc. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Radial scar is a growth that looks like a scar when " +
                                    "the tissue is viewed under a microscope. ",
                                    "It has a central core containing benign ducts. ",
                                    "Growing out of this core are ducts and lobules that " +
                                    "show evidence of unusual changes such as cysts and " +
                                    "epithelial hyperplasia (overgrowth of their inner " +
                                    "lining). ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("The use of high-energy radiation from x-rays, gamma " +
                                    ...
                                    "(external-beam radiation therapy), or it may come " +
                                    "from radioactive material placed in the body near " +
                                    "cancer cells (internal radiation therapy or brachytherapy). ",
                                    "Systemic radiation therapy uses a radioactive substance, " +
                                    "such as a radiolabeled monoclonal antibody, that " +
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("In cases when the appropriate history is not available, " +
                                    "a postsurgical scar may mimic a malignancy. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("Sclerosing adenosis is a type of adenosis in which " +
                                    ...
                                    "maintained, but becomes exaggerated and distorted.")
                            ,
                            new ConceptDef()
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("The sentinel nodes are the first few lymph nodes " +
                                    ...
                                    "material that helps the surgeon locate the sentinel " +
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("A breast seroma is a collection (pocket) of serous " +
                                    ...
                                    "that contains protein, but no blood cells or pus. ",
                            ...
                            new ConceptDef()
                                ...
                                .SetUMLS("The branch of medicine that employs operations in " +
                                    ...
                                    "or otherwise physically changing body tissues and " +
                                    "organs. ",
