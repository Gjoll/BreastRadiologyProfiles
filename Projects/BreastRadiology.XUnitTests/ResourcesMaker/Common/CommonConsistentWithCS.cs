...
namespace BreastRadiology.XUnitTests
{
    ...
    {
       CSTaskVar CommonConsistentWithCS = new CSTaskVar(
            () =>
                ResourcesMaker.Self.CreateCodeSystem(
                        "CommonConsistentWith",
                        "Common Consistent With",
                        "CommonWith/ValueSet",
                        "Consistent With",
                        Group_CommonCodes,
                        new ConceptDef[]
        ...
        CSTaskVar CommonConsistentWithQualifierCS = new CSTaskVar(
             () =>
                 ResourcesMaker.Self.CreateCodeSystem(
                        "CommonConsistentWithQualifier",
                        "Common ConsistentWith Qualifier",
                        "CommonWithQualifier/ValueSet",
