                    ...
                    new ConceptDef[]
                    {
                        ...
                        new ConceptDef()
                            ...
                            .SetACR("This term should be used when relatively few calcifications " +
                                ...
                                "5 calcifications are grouped within 1 cm of each " +
                        ...
                        new ConceptDef()
                            ...
                            .SetACR("These are calcifications arrayed in a line. This " +
                                ...
                                "vascular and large rod-like calcifications also are " +
                                "usually linear in distribution, but that these typically " +
                        ...
                        new ConceptDef()
                            ...
                            .SetACR("This descriptor is used for numerous calcifications " +
                                ...
                                "to a duct distribution. Since this distribution may " +
                                "involve most of a quadrant or even more than a single " +
                                "quadrant, malignancy is less likely. However, overall " +
                                "evaluation of regional calcifications must include " +
                                "particle shape (morphology) as well as distribution.")
                        ,
                        new ConceptDef()
                        ...
                        new ConceptDef()
                            ...
                            .SetACR("Calcifications in a segmental distribution are of " +
                                ...
                                "or segment of the breast. Although benign causes " +
                                "of segmental calcifications exist (e.g. large rod-like), " +
                                "the smooth, rod-like morphology and large size of " +
                                "benign calcifications distinguish them from finer, " +
                                "more pleomorphic or heterogeneous malignant calcifications. " +
