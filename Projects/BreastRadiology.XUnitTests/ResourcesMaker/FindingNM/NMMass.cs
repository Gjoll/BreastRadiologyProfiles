        ...
        void CreateNMMass()
        {
...

            {
                ProfileTargetSlice[] targets = new ProfileTargetSlice[]
                {
                    ...
                    new ProfileTargetSlice(this.NMMassMargin(), 0, "*"),
                    //$new ProfileTargetSlice(this.NMMassDensity(), 0, "1"),
                    new ProfileTargetSlice(this.CommonObservedChangeInState(), 0, "*"),
                    //$new ProfileTargetSlice(this.NMAssociatedFeatures(), 0, "1", false),
                };
