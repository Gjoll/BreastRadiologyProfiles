...
{
	public class MGAbnormalityFatNecrosis : BreastRadBase, IObservationLeafFragment, IBreastRadObservationNoDeviceFragment, IBreastRadObservationNoValueFragment, ICommonComponentsFragment, IShapeComponentsFragment, INotPreviouslySeenComponentFragment, IObservedCountFragment, ICorrespondsWithFragment
	{
		//+ Fields
		public HasMemberList<IAssociatedFeatures> AssociatedFeatures {get;}                                                                       // CSBuilder.cs:222
		public HasMemberList<IConsistentWith> ConsistentWith {get;}                                                                               // CSBuilder.cs:222
		//- Fields

		//+ Constructor
		public MGAbnormalityFatNecrosis()                                                                                                         // CSBuilder.cs:308
		{                                                                                                                                         // CSBuilder.cs:309
		    this.AssociatedFeatures = new HasMemberList<IAssociatedFeatures>(0, 1);                                                               // CSBuilder.cs:236
		    this.ConsistentWith = new HasMemberList<IConsistentWith>(0, -1);                                                                      // CSBuilder.cs:236
		}                                                                                                                                         // CSBuilder.cs:311
		//- Constructor
