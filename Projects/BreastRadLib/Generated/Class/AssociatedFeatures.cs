...
{
	//+ Header
	public class AssociatedFeatures : BreastRadBase, IAssociatedFeatures                                                                       // CSBuilder.cs:312
	//- Header
	{
		//+ Fields
		...
		public HasMemberList<IObservedFeature> ObservedFeature {get;}                                                                             // CSBuilder.cs:220
		//- Fields

		//+ Constructor
		public AssociatedFeatures()                                                                                                               // CSBuilder.cs:318
		{                                                                                                                                         // CSBuilder.cs:319
		    ...
		    this.ObservedFeature = new HasMemberList<IObservedFeature>(0, -1);                                                                    // CSBuilder.cs:234
		}                                                                                                                                         // CSBuilder.cs:321
		//- Constructor
