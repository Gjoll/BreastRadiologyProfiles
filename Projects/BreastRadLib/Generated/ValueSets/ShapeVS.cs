...
namespace BreastRadLib
{
	...
	//- Header
	{
		...
		{                                                                                                                                         // CSBuilder.cs:346
		    ...
		    this.Members.Add(ShapeCS.Code_IrregularInShape);                                                                                      // CSBuilder.cs:390
		    this.Members.Add(ShapeCS.Code_OvalInShape);                                                                                           // CSBuilder.cs:390
		    this.Members.Add(ShapeCS.Code_RoundInShape);                                                                                          // CSBuilder.cs:390
		}                                                                                                                                         // CSBuilder.cs:349
		//- Fields
	}
}
