...
namespace BreastRadLib
{
	...
	//- Header
	{
		...
		{                                                                                                                                         // CSBuilder.cs:346
		    ...
		    this.Members.Add(this.Code_Diffuse);                                                                                                  // CSBuilder.cs:390
		    this.Members.Add(this.Code_Regional);                                                                                                 // CSBuilder.cs:390
		    this.Members.Add(this.Code_Grouped);                                                                                                  // CSBuilder.cs:390
		    this.Members.Add(this.Code_Linear);                                                                                                   // CSBuilder.cs:390
		    this.Members.Add(this.Code_Segmental);                                                                                                // CSBuilder.cs:390
		}                                                                                                                                         // CSBuilder.cs:349
		//- Fields
	}
}
