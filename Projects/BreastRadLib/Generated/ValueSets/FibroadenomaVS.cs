...
{
	//+ Header
	public class FibroadenomaVS                                                                                                                // CSBuilder.cs:331
	//- Header
	{
		//+ Fields
		/// <summary>
		...
		public TCoding Code_Fibroadenoma = new TCoding(FibroadenomaCodeSystemCS.Code_Fibroadenoma);                                               // CSBuilder.cs:382
		public TCoding Code_FibroadenomaDegeneration = new TCoding(FibroadenomaCodeSystemCS.Code_FibroadenomaDegeneration);                       // CSBuilder.cs:382
		                                                                                                                                          // CSBuilder.cs:337
		public List<Coding> Members;                                                                                                              // CSBuilder.cs:338
		                                                                                                                                          // CSBuilder.cs:339
		public FibroadenomaVS()                                                                                                                   // CSBuilder.cs:340
		{                                                                                                                                         // CSBuilder.cs:341
		    this.Members = new List<Coding>();                                                                                                    // CSBuilder.cs:342
		    this.Members.Add(this.Code_Fibroadenoma);                                                                                             // CSBuilder.cs:385
		    this.Members.Add(this.Code_FibroadenomaDegeneration);                                                                                 // CSBuilder.cs:385
		}                                                                                                                                         // CSBuilder.cs:344
		//- Fields
	}
}
