...
{
	//+ Header
	public class FibroadenomaVS                                                                                                                // CSBuilder.cs:361
	//- Header
	{
		//+ Fields
		/// <summary>
		...
		public TCoding Code_Normal = new TCoding(FibroadenomaCodeSystemCS.Code_Normal);                                                           // CSBuilder.cs:412
		public TCoding Code_Degenerated = new TCoding(FibroadenomaCodeSystemCS.Code_Degenerated);                                                 // CSBuilder.cs:412
		                                                                                                                                          // CSBuilder.cs:367
		public List<Coding> Members;                                                                                                              // CSBuilder.cs:368
		                                                                                                                                          // CSBuilder.cs:369
		public FibroadenomaVS()                                                                                                                   // CSBuilder.cs:370
		{                                                                                                                                         // CSBuilder.cs:371
		    this.Members = new List<Coding>();                                                                                                    // CSBuilder.cs:372
		    this.Members.Add(this.Code_Normal);                                                                                                   // CSBuilder.cs:415
		    this.Members.Add(this.Code_Degenerated);                                                                                              // CSBuilder.cs:415
		}                                                                                                                                         // CSBuilder.cs:374
		//- Fields
	}
}
