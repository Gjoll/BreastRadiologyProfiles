...
{
	//+ Header
	public class FibroadenomaVS                                                                                                                // CSBuilder.cs:413
	//- Header
	{
		//+ Fields
		/// <summary>
		...
		public TCoding Code_Normal = new TCoding(FibroadenomaCodeSystemCS.Code_Normal);                                                           // CSBuilder.cs:464
		public TCoding Code_Degenerated = new TCoding(FibroadenomaCodeSystemCS.Code_Degenerated);                                                 // CSBuilder.cs:464
		                                                                                                                                          // CSBuilder.cs:419
		public List<Coding> Members;                                                                                                              // CSBuilder.cs:420
		                                                                                                                                          // CSBuilder.cs:421
		public FibroadenomaVS()                                                                                                                   // CSBuilder.cs:422
		{                                                                                                                                         // CSBuilder.cs:423
		    this.Members = new List<Coding>();                                                                                                    // CSBuilder.cs:424
		    this.Members.Add(this.Code_Normal);                                                                                                   // CSBuilder.cs:467
		    this.Members.Add(this.Code_Degenerated);                                                                                              // CSBuilder.cs:467
		}                                                                                                                                         // CSBuilder.cs:426
		//- Fields
	}
}
