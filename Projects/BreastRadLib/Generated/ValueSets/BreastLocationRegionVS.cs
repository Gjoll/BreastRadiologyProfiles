...
namespace BreastRadLib
{
	...
	//- Header
	{
		...
		{                                                                                                                                         // CSBuilder.cs:346
		    ...
		    this.Members.Add(this.Code_Central);                                                                                                  // CSBuilder.cs:390
		    this.Members.Add(this.Code_RetroaReolar);                                                                                             // CSBuilder.cs:390
		    this.Members.Add(this.Code_AxillaryTail);                                                                                             // CSBuilder.cs:390
		    this.Members.Add(this.Code_Axilla);                                                                                                   // CSBuilder.cs:390
		    this.Members.Add(this.Code_AxillaI);                                                                                                  // CSBuilder.cs:390
		    this.Members.Add(this.Code_AxillaII);                                                                                                 // CSBuilder.cs:390
		    this.Members.Add(this.Code_AxillaIII);                                                                                                // CSBuilder.cs:390
		    this.Members.Add(this.Code_InframammaryFold);                                                                                         // CSBuilder.cs:390
		    this.Members.Add(this.Code_InSkin);                                                                                                   // CSBuilder.cs:390
		}                                                                                                                                         // CSBuilder.cs:349
		//- Fields
	}
}
