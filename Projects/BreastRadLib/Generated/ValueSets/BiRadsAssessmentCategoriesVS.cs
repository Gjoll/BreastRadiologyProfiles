...
namespace BreastRadLib
{
	...
	//- Header
	{
		...
		{                                                                                                                                         // CSBuilder.cs:346
		    ...
		    this.Members.Add(this.Code_Category0);                                                                                                // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category1);                                                                                                // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category2);                                                                                                // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category3);                                                                                                // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category4);                                                                                                // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category4A);                                                                                               // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category4B);                                                                                               // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category4C);                                                                                               // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category5);                                                                                                // CSBuilder.cs:390
		    this.Members.Add(this.Code_Category6);                                                                                                // CSBuilder.cs:390
		    this.Members.Add(this.Code_PostBiopsyMarker);                                                                                         // CSBuilder.cs:390
		    this.Members.Add(this.Code_MarkerClipPlacement);                                                                                      // CSBuilder.cs:390
		}                                                                                                                                         // CSBuilder.cs:349
		//- Fields
	}
}
