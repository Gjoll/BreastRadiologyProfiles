...
namespace BreastRadLib
{
	...
	//- Header
	{
		...
		{                                                                                                                                         // CSBuilder.cs:346
		    ...
		    this.Members.Add(this.Code_Anterior);                                                                                                 // CSBuilder.cs:390
		    this.Members.Add(this.Code_Middle);                                                                                                   // CSBuilder.cs:390
		    this.Members.Add(this.Code_Posterior);                                                                                                // CSBuilder.cs:390
		}                                                                                                                                         // CSBuilder.cs:349
		//- Fields
	}
}
