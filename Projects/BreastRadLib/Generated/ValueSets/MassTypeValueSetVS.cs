...
namespace BreastRadLib
{
	...
	//- Header
	{
		...
		{                                                                                                                                         // CSBuilder.cs:346
		    ...
		    this.Members.Add(this.Code_Solid);                                                                                                    // CSBuilder.cs:390
		    this.Members.Add(this.Code_Intraductal);                                                                                              // CSBuilder.cs:390
		    this.Members.Add(this.Code_PartiallySolid);                                                                                           // CSBuilder.cs:390
