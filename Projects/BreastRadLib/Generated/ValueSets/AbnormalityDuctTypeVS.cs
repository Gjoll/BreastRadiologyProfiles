...
namespace BreastRadLib
{
	...
	//- Header
	{
		...
		{                                                                                                                                         // CSBuilder.cs:346
		    ...
		    this.Members.Add(AbnormalityDuctTypeCS.Code_Normal);                                                                                  // CSBuilder.cs:390
		    this.Members.Add(AbnormalityDuctTypeCS.Code_Ectasia);                                                                                 // CSBuilder.cs:390
		    this.Members.Add(AbnormalityDuctTypeCS.Code_Dilated);                                                                                 // CSBuilder.cs:390
		}                                                                                                                                         // CSBuilder.cs:349
		//- Fields
	}
}
