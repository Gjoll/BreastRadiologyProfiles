...
namespace BreastRadLib
{
	...
	//- Header
	{
		...
		{                                                                                                                                         // CSBuilder.cs:346
		    ...
		    this.Members.Add(this.Code_Fatty);                                                                                                    // CSBuilder.cs:390
		    this.Members.Add(this.Code_Fibroglandular);                                                                                           // CSBuilder.cs:390
		    this.Members.Add(this.Code_HeterogeneouslyDense);                                                                                     // CSBuilder.cs:390
		    this.Members.Add(this.Code_ExtremelyDense);                                                                                           // CSBuilder.cs:390
		}                                                                                                                                         // CSBuilder.cs:349
		//- Fields
	}
}
