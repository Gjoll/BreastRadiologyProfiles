...
{
	//+ Header
	public class AbnormalityDuctTypeCS                                                                                                         // CSBuilder.cs:380
	//- Header
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/AbnormalityDuctTypeCS";                                         // CSBuilder.cs:384
		                                                                                                                                          // CSBuilder.cs:396
		/// <summary>
		/// [PR]
		/// </summary>
		...
		/// [PR]
		/// </summary>
		public static Coding Code_Ectasia = new Coding(System, "Ectasia", "Ectasia");                                                             // CSBuilder.cs:410
		                                                                                                                                          // CSBuilder.cs:396
		/// <summary>
		...
		/// </summary>
		public static Coding Code_Dilated = new Coding(System, "Dilated", "Dilated");                                                             // CSBuilder.cs:410
		//- Fields
	}
}
