...
{
	//+ Header
	public class MammoCalcificationDistributionCS                                                                                              // CSBuilder.cs:475
	//- Header
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/MammoCalcificationDistributionCS";                              // CSBuilder.cs:479
		                                                                                                                                          // CSBuilder.cs:491
		/// <summary>
		...
		/// </summary>
		public static Coding Code_Diffuse = new Coding(System, "Diffuse", "Diffuse Calcification Distribution");                                  // CSBuilder.cs:505
		                                                                                                                                          // CSBuilder.cs:491
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Regional = new Coding(System, "Regional", "Regional  Calcification Distribution");                              // CSBuilder.cs:505
		                                                                                                                                          // CSBuilder.cs:491
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Grouped = new Coding(System, "Grouped", "Grouped  Calcification Distribution");                                 // CSBuilder.cs:505
		                                                                                                                                          // CSBuilder.cs:491
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Linear = new Coding(System, "Linear", "Linear  Calcification Distribution");                                    // CSBuilder.cs:505
		                                                                                                                                          // CSBuilder.cs:491
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Segmental = new Coding(System, "Segmental", "Segmental Calcification Distribution");                            // CSBuilder.cs:505
		//- Fields
	}
}
