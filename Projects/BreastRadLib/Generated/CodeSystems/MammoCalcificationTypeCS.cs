...
{
	//+ Header
	public class MammoCalcificationTypeCS                                                                                                      // CSBuilder.cs:485
	//- Header
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/MammoCalcificationTypeCS";                                      // CSBuilder.cs:489
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// </summary>
		public static Coding Code_Skin = new Coding(System, "Skin", "Skin Calcification (Typically Benign)");                                     // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Vascular = new Coding(System, "Vascular", "Vascular Calcification (Typically Benign)");                         // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// These are the classic large (> 2 to 3 mm in greatest diameter) calcifications produced by an involuting fibroadenoma.
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Coarse = new Coding(System, "Coarse", "Coarse or 'Popcorn-like' Calcification (Typically Benign)");             // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_LargeRodLike = new Coding(System, "LargeRodLike", "Large Rod-Like Calcification (Typically Benign)");           // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Round = new Coding(System, "Round", "Round (Typically Benign)");                                                // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Rim = new Coding(System, "Rim", "Rim  Calcification (Typically Benign)");                                       // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Dystrophic = new Coding(System, "Dystrophic", "Dystrophic Calcification (Typically Benign)");                   // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_MilkOfCalcium = new Coding(System, "MilkOfCalcium", "Milk of Calcium Calcification (Typically Benign)");        // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Suture = new Coding(System, "Suture", "Suture Calcification (Typically Benign)");                               // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Amorphous = new Coding(System, "Amorphous", "Amorphous Calcification (Suspicious Morphology)");                 // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_CoarseHeterogeneous = new Coding(System, "CoarseHeterogeneous", "Coarse Heterogeneous Calcification (Suspicious Morphology)");// CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_FinePleomorphic = new Coding(System, "Fine Pleomorphic", "Fine Pleomorphic Calcification (Suspicious Morphology)");// CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_FineLinear = new Coding(System, "FineLinear", "Fine Linear or Fine-Linear Branching Calcification (Suspicious Morphology)");// CSBuilder.cs:515
		//- Fields
	}
}
