...
{
	//+ Header
	public class MGBreastDensityCS                                                                                                             // CSBuilder.cs:380
	//- Header
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/MGBreastDensityCS";                                             // CSBuilder.cs:384
		                                                                                                                                          // CSBuilder.cs:396
		/// <summary>
		...
		/// </summary>
		public static Coding Code_Fatty = new Coding(System, "Fatty", "The breasts are almost entirely fatty");                                   // CSBuilder.cs:410
		                                                                                                                                          // CSBuilder.cs:396
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_Fibroglandular = new Coding(System, "Fibroglandular", "Scattered areas of fibroglandular density");             // CSBuilder.cs:410
		                                                                                                                                          // CSBuilder.cs:396
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_HeterogeneouslyDense = new Coding(System, "HeterogeneouslyDense", "The breasts are heterogeneously dense, which may obscure detection of small masses");// CSBuilder.cs:410
		                                                                                                                                          // CSBuilder.cs:396
		/// <summary>
		...
		/// -- Bi-Rads® Atlas — Mammography Fifth Ed. 2013
		/// </summary>
		public static Coding Code_ExtremelyDense = new Coding(System, "ExtremelyDense", "The breasts are extremely dense, which lowers the sensitivity of mammography.");// CSBuilder.cs:410
		//- Fields
	}
}
