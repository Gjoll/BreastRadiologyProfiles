...
{
	//+ Header
	public class ObservedFeatureCS                                                                                                             // CSBuilder.cs:485
	//- Header
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservedFeatureCS";                                             // CSBuilder.cs:489
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// Axillary adenopathy
		...
		/// </summary>
		public static Coding Code_AxillaryAdenopathy = new Coding(System, "AxillaryAdenopathy", "Axillary adenopathy");                           // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Biopsy clip
		...
		/// </summary>
		public static Coding Code_BrachytherapyTube = new Coding(System, "BrachytherapyTube", "Brachytherapy tube");                              // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Chest wall invasion
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_ChestWallInvasion = new Coding(System, "ChestWallInvasion", "Chest wall invasion");                             // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Cooper distorted
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_CooperDistorted = new Coding(System, "CooperDistorted", "Cooper distorted");                                    // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Cooper thickened
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_CooperThickened = new Coding(System, "CooperThickened", "Cooper thickened");                                    // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Edema
		/// Valid for the following modalities: US.
		...
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_EdemaAdj = new Coding(System, "EdemaAdj", "Edema adj");                                                         // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Gold Seed
		/// Valid for the following modalities: MG.
		...
		/// Valid for the following modalities: MG MRI.
		/// </summary>
		public static Coding Code_NippleRetraction = new Coding(System, "NippleRetraction", "Nipple retraction");                                 // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] NO Chest wall invasion
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_NOChestWallInvasion = new Coding(System, "NOChestWallInvasion", "NO Chest wall invasion");                      // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Pectoralis muscle invasion
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_PectoralisMuscleInvasion = new Coding(System, "PectoralisMuscleInvasion", "Pectoralis muscle invasion");        // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Pectoralis muscle involvement
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_PectoralisMuscleInvolvement = new Coding(System, "PectoralisMuscleInvolvement", "Pectoralis muscle involvement");// CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Pectoralis muscle tenting
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_PectoralisMuscleTenting = new Coding(System, "PectoralisMuscleTenting", "Pectoralis muscle tenting");           // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_SkinInvolvement = new Coding(System, "SkinInvolvement", "Skin involvement");                                    // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// Skin lesion
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_SkinRetraction = new Coding(System, "SkinRetraction", "Skin retraction");                                       // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// Skin thickening
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_SkinThickening = new Coding(System, "SkinThickening", "Skin thickening");                                       // CSBuilder.cs:515
		                                                                                                                                          // CSBuilder.cs:501
		/// <summary>
		/// [PR] Surgical clip
		/// Valid for the following modalities: MG.
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_TrabecularThickening = new Coding(System, "TrabecularThickening", "Trabecular thickening");                     // CSBuilder.cs:515
		//- Fields
	}
}
